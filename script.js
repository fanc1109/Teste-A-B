...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnSubmit.addEventListener('click', (e) => {
        ...
        if (todosPreenchidos) {
            ...
            btnSubmit.innerText = "ENVIANDO COM CARINHO...";
            btnSubmit.disabled = true;

            // Simula uma espera de rede (1.5 segundos) antes de confirmar
            setTimeout(() => {
                alert('✨ Cadastro realizado com sucesso no Ninho Fofinho!');
                
                // Reseta o botão para o estado original
                btnSubmit.innerText = "CADASTRAR AGORA";
            ...
            alert('Ops! Por favor, preencha todos os campos para ganhar seus brindes. 🐣');
        }
    });
});
